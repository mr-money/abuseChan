...
insert  into `abuse_admin_user`(`id`,`nickname`,`telphone`,`password`,`realname`,`avatar`,`remember_token`,`backup`,`created_at`,`updated_at`) values (1001,'admin','18651984625','96E79218965EB72C92A549DD5A330112','钱京',NULL,NULL,NULL,'2019-01-26 11:18:36','2019-01-26 11:18:36');
...
insert  into `abuse_wx_user`(`id`,`openid`,`nickname`,`avatar`,`sex`,`subscribe_time`,`address`,`realname`,`tel`,`city`,`province`,`country`,`backup`,`state`,`create_at`,`uptate_at`) values (1001,'1','昵称','http://thirdwx.qlogo.cn/mmopen/yTRjlqxLq89we6kVqcyQ3frotPvKYZNLrMXnRuOeYqicjZiaO9YRmBEicI1gl50bpZOPCxtZIakZVyHxquqq0iaEjbtXnvqebJL6/132',1,123123123,'上海上海','钱京','123456','上海','上海','中国','1',0,'2019-01-24 17:06:11','2019-01-24 17:06:11');
