                ...
                <div class="widget-body am-fr">
                    ...
                    <form class="am-form tpl-form-border-form tpl-form-border-br" id="form">
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" class="tpl-form-input" id="nickname" name="nickname"
                                       placeholder="请输入昵称"
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" class="tpl-form-input" id="telphone" name="telphone"
                                       placeholder="请输入手机号"
                        ...
                        <div class="am-form-group">
                            <label for="realname" class="am-u-sm-3 am-form-label">真实姓名 <span
                                    class="tpl-form-line-small-title">telphone</span></label>
                            <div class="am-u-sm-9">
                                <input type="text" class="tpl-form-input" id="realname" name="realname"
                                       placeholder="请输入真实姓名"
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <button type="button" class="am-btn am-btn-danger am-radius am-btn-block am-btn-sm"
                                        style="width: 12%" id="password">修改密码
                                </button>
                                <small>点击修改密码。</small>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <textarea class="" rows="10" id="backup" name="backup"
                                          placeholder="请输入内容"><?= $admin['backup'] ?></textarea>
                            </div>
                        </div>
...
<script>
    $(function () {
        ...
        $('#password').on('click', function () {
            ...
            $('#editPassword').modal({
                relatedTarget: this,
                closeOnConfirm: false, //确定不关闭窗口
                closeOnCancel: true, //取消关闭窗口
                onConfirm: function (e) {
                    ...
                    if(newpassword1 == '' || newpassword2 == ''){
                        ...
                        if(passFlag){
                            $.post(
                                "<?= \yii\helpers\Url::to(['admin/edit-password-ajax']) ?>",
                                {
                                    password: hex_md5(newpassword2),
                                },
                                function (data) {
//                                    console.log(data);
            ...
            $.post(
                ...
                function (data) {
                    ...
                    if (data.code == 1000) {
                        ...
                        $this.prev().children().removeClass('am-icon-lock');
                        $this.prev().children().removeClass('am-icon-times');
                        $this.prev().children().addClass('am-icon-check');
                    } else {
                        passFlag = false;
                        ...
                        $this.prev().children().removeClass('am-icon-lock');
                        $this.prev().children().removeClass('am-icon-check');
                        $this.prev().children().addClass('am-icon-times');
                    }
                },
                "json"
            );
