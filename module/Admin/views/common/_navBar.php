<div class="left-sidebar">
    ...
    <div class="tpl-sidebar-user-panel">
        <div class="tpl-user-panel-slide-toggleable">
            ...
            <a href="javascript:navRedirect('<?= $admin['nickname']; ?>账号设置','<?= \yii\helpers\Url::to('admin-user'); ?>');;" class="tpl-user-panel-action-link"> <span class="am-icon-pencil"></span> 账号设置</a>
        </div>
    </div>
